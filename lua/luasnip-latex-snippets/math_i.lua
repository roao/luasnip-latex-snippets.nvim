...
function M.retrieve(is_math)
  ...
  return {
    ...
    parse_snippet({ trig = "ddx", name = "d/dx" }, "\\frac{\\mathrm{d}$1}{\\mathrm{d}${2:x}} $0"),
    parse_snippet(
    ...
    parse_snippet({ trig = "pa", name = "partial" }, "\\partial "),
    parse_snippet({ trig = "pp", name = "partial" }, "\\| "),
    parse_snippet({ trig = "pe", name = "partial" }, "\\perp "),
    parse_snippet({ trig = "al", name = "alpha" }, "\\alpha "),
    parse_snippet({ trig = "be", name = "beta" }, "\\beta "),
    parse_snippet({ trig = "de", name = "delta" }, "\\delta "),
    parse_snippet({ trig = "DE", name = "Delta" }, "\\Delta "),
    parse_snippet({ trig = "ep", name = "epsilon" }, "\\epsilon "),
    parse_snippet({ trig = "vep", name = "varepsilon" }, "\\varepsilon "),
    parse_snippet({ trig = "ga", name = "gamma" }, "\\gamma "),
    parse_snippet({ trig = "GA", name = "Gamma" }, "\\Gamma "),
    parse_snippet({ trig = "ph", name = "phi" }, "\\phi "),
    parse_snippet({ trig = "PH", name = "Phi" }, "\\Phi "),
    parse_snippet({ trig = "vph", name = "varphi" }, "\\varphi "),
    parse_snippet({ trig = "ka", name = "kappa" }, "\\kappa "),
    parse_snippet({ trig = "la", name = "lambda" }, "\\lambda "),
    parse_snippet({ trig = "LA", name = "Lambda" }, "\\Lambda "),
    ...
    parse_snippet({ trig = "th", name = "theta" }, "\\theta "),
    parse_snippet({ trig = "TH", name = "Theta" }, "\\Theta "),
    parse_snippet({ trig = "et", name = "eta" }, "\\eta "),
    parse_snippet({ trig = "na", name = "nabla" }, "\\nabla "),
    -- parse_snippet(
